...
<body style="background: none repeat scroll 0 0 #EEEEEE;">
	<form id="updateAccessorForm" action="${ctx}/front_sys/accessor/updateAccessor.htm" method="post">
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							...
							<tbody>
									<tr>
										<td width="12%">业务代码</td>
										<td width="36%"><input type="text" name="BUSINESSCODE" value="${accessor.BUSINESSCODE}" id="BUSINESSCODE" /></td>
										<td width="12%">业务名称</td>
										<td><input type="text" name="BUSINESSNAME" value="${accessor.BUSINESSNAME}" id="BUSINESSNAME" /></td>
									</tr>
									<tr>
										<td>文件名称</td>
										<td><input type="text" name="FILENAME" value="${accessor.FILENAME}" id="FILENAME"/></td>
										<td>文件地址</td>
										<td><input type="text" name="FILEPATH" value="${accessor.FILEPATH}" id="FILEPATH" /></td>
									</tr>
									<tr>
										
										<td>文件类型</td>
										    <td><input type="text" name="FILETYPE" value="${accessor.FILETYPE}" id="FILETYPE"/></td>
										<td>文件说明</td>
										<td><input type="text" name="FILEEXPLAIN" value="${accessor.FILEEXPLAIN}" id="FILEEXPLAIN"/></td>
									</tr>
									
								</tbody>
							</table>
							<div class="form-actions">
								<input type='hidden' name='BAID' value='${accessor.BAID}'/>
...
<!-- 简介图片上传 -->
	...
	function update() {
		$('#updateAccessorForm').ajaxSubmit(function(data) {
			if (data == "success") {
				alert("保存成功");
